...
exports.scrapeCoveLink = scrapeCoveLink;
exports.scrapeMamikosLink = scrapeMamikosLink;
exports.scrapeRukitaLink = scrapeRukitaLink;
const functions_1 = require("./functions");
async function scrapeCoveLink(url, page) {
    try {
...
async function scrapeMamikosLink(url, page) {
    try {
        const extractPriceFunc = functions_1.extractPrice.toString();
...
async function scrapeRukitaLink(url, page) {
    try {
        const extractPriceFunc = functions_1.extractPrice.toString();
        const data = await page.evaluate((extractPriceString, pageUrl) => {
            var _a, _b, _c, _d;
